...
def get_columns():
    return [
        ...
        {"label": "Purchase Negotiation Committee", "fieldname": "pnc", "fieldtype": "Link", "options": "Purchase Negotiation Committee", "width": 180},
...
def get_data(filters):
    ...
    for indent in indents:
        ...
        # PNC
        pnc = frappe.db.get_value("Purchase Negotiation Committee", {"indent_reference": indent.name}, ["name", "workflow_state"], as_dict=True)
        if pnc:
            row.update({
                "pnc": pnc.name,
